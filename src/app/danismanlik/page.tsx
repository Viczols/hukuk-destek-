...
export default function DanismanlikPage() {
  return (
    <>
      <Navbar
        variant="consulting"
        hideLinks={["paketler", "blog", "danismanlik"]}
        extraRight={
          <a href="#avukatlar" className="px-3 py-2 rounded-full hover:bg-zinc-100 transition-colors">
            Avukatlar
          </a>
        }
      />
      ...
      <main className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white">
        {/* RANDEVU MODALI (tüm /randevu/* linklerini yakalar) */}
        <BookingModal />
          ...
          <div className="max-w-6xl mx-auto px-6 py-20 md:py-28 relative">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-zinc-300 max-w-2xl">
                Size uygun uzmanı seçin, takvimden uygun bir saat belirleyin ve dakikalar içinde görüşmenizi başlatın.
                Tümü tek panelden, güvenle.
              </p>
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur">
                <div className="size-10 grid place-items-center rounded-full bg-white text-black font-bold">{i + 1}</div>
        ...
        <section id="avukatlar" className="max-w-6xl mx-auto px-6 py-16 md:py-20">
          <div className="flex items-end justify-between">
            ...
            <a href="/avukatlar" className="text-sm text-zinc-300 hover:text-white transition">
              Tümünü gör →
            </a>
          </div>

          <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* 1) DOLDURULMUŞ ÖRNEK KART (Av. Zeynep) */}
            <div className="group overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-[#0E1524] to-[#070B13] shadow-[0_0_0_1px_rgba(255,255,255,0.04)] hover:shadow-[0_0_0_1px_rgba(255,255,255,0.06)] transition">
              <div className="relative h-40">
                <div className="absolute inset-0 bg-[radial-gradient(600px_200px_at_20%_10%,rgba(59,130,246,0.25),transparent_60%)]" />
                <div className="absolute inset-0 grid place-items-center">
                  <div className="size-16 rounded-full bg-white text-black grid place-items-center text-xl font-semibold shadow">
                    Z
                  </div>
                </div>
              </div>
              <div className="p-5">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-semibold text-white">Av. Zeynep</h3>
                </div>
                <p className="mt-1 text-sm text-zinc-300">Kira Hukuku, Tüketici Hukuku</p>
                <p className="mt-2 text-sm text-zinc-400 line-clamp-2">
                  Kira tespit davaları, tahliye süreçleri ve tüketici uyuşmazlıklarında pratik çözümler.
                </p>
                ...
                <div className="mt-4 flex items-center gap-2">
                  ...
                  {/* Profili gör modalı ayrı tutuluyor */}
                  <LawyerProfileModal />
                </div>
              </div>
            </div>

            {/* 2-3) Placeholder örnekleri */}
            {[2, 3].map((i) => (
              <div
                key={i}
                className="group overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-[#0E1524] to-[#070B13] shadow-[0_0_0_1px_rgba(255,255,255,0.04)] hover:shadow-[0_0_0_1px_rgba(255,255,255,0.06)] transition"
              >
                <div className="relative h-40">
                  <div className="absolute inset-0 bg-[radial-gradient(600px_200px_at_20%_10%,rgba(59,130,246,0.22),transparent_60%)]" />
                  <div className="absolute inset-0 grid place-items-center">
                    <div className="size-16 rounded-full bg-white/85" />
                  </div>
                </div>
                <div className="p-5">
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-semibold text-white">Av. Ad</h3>
                  </div>
        ...
        <section className="max-w-6xl mx-auto px-6 pb-20">
          <div className="rounded-3xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] p-8 md:p-10 text-center">
            <h3 className="text-2xl md:text-3xl font-semibold text-white">İlk danışmanlığınızı şimdi planlayın</h3>
            <p className="mt-2 text-zinc-300">Uygun bir saat seçin, uzmanla online görüşmeye başlayın.</p>
            <div className="mt-6 flex items-center justify-center gap-3">
              <a href="#avukatlar" className="rounded-full bg-white text-black px-5 py-2.5 font-semibold hover:bg-zinc-100 transition">
                Avukatları Gör
              </a>
              <a href="/avukatlar" className="rounded-full border border-white/15 bg-white/5 px-5 py-2.5 text-zinc-200 hover:bg-white/10 transition">
                Tüm Uzmanlar
              </a>
            </div>
          </div>
            ...
            {[
              ...
              <details key={i} className="group rounded-xl border border-white/10 bg-white/5 p-4">
                <summary className="cursor-pointer list-none text-white font-medium flex items-center justify-between">
                  {qa.q}
                  <span className="text-zinc-300 group-open:rotate-180 transition">▼</span>
                </summary>
